...
exports.handler = async (event, context) => {
  ...
  try {
    ...
    const templateParams = {
      ...
      selectedServices: Number(data.selectedServices || 0),
      service_type: data.servicesList,
      servicePrice: Number(data.servicePrice || 0),
      urgencyCost: Number(data.urgencyCost || 0),
      warrantyPrice: Number(data.warrantyPrice || 0),
      total: data.total || 0,
      urgencyText: data.urgencyText || 'Normal (3-5 días)',
      urgencyMultiplier: data.urgencyMultiplier || '1x',
      warrantyText: data.warrantyText || '30 días',
      preferred_date: data.preferred_date || '',
      problemDescription: data.problemDescription || data.message || 'Sin descripción',
